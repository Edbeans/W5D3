...
CREATE TABLE questions (
    ...
    title TEXT NOT NULL,
    body TEXT NOT NULL,
    associated_authors_id INTEGER NOT NULL,  
    
    FOREIGN KEY (associated_authors_id) REFERENCES users(id) 
);

INSERT INTO
  questions (title, body, associated_authors_id)
SELECT
...
CREATE TABLE replies (
    id INTEGER PRIMARY KEY,
    /* Reply reference to subject(title) */ 
    question_id INTEGER NOT NULL,
    /* Reply reference to parent reply (previous reply) */
    parent_reply_id INTEGER, 
    /* Reply reference to the user who wrote it */
    user_id INTEGER NOT NULL, 
    /* Keeping track of the body */
    body TEXT NOT NULL,
...
INSERT INTO
  question_likes (user_likes_id, question_liked_id)
VALUES
  ((SELECT id FROM users WHERE fname = "Kush" AND lname = "Patel"),
  (SELECT id FROM questions WHERE title = "Earl Question")
);
...
INSERT INTO question_likes (user_likes_id, question_liked_id) VALUES (1, 1);
INSERT INTO question_likes (user_likes_id, question_liked_id) VALUES (1, 2);